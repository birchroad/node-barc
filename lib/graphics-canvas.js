...
var Graphics = function(width, height, border, padding, font){
	this.width = width;
	this.height = height;

	if(typeof border == 'function'){
		this.border_width = border(width, height);
	}
	else{
	...
	this.area ={
		width:width-this.border_size * 2 - this.padding_width *2
		, height:height - this.border_size * 2
		, top = this.border_size
		, left = this.border_size + this.padding_width };
	...
	this.fillBgRect(this.border_size,this.border_size
			, width-this.border_size*2, height-this.border_size*2);
...
Graphics.prototype.fillText = function(text, x, y){
	...
	this.fillBgRect(left-this.font_size, top, b.width+this.font_size*2, this.font_size);
