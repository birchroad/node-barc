...
callback(err, code)
*/
Barcode.prototype.code2of5 = function(code, width, height, angle, callback){
	...
	g = new Graphics(width, height, this.border, this.padding, this.font);
